...
[scenario13.yaml](https://github.com/Dynatrace/demo-opentelemetry-patterns/blob/main/scenario13.yaml){target=_blank} shows the base OpenTelemetry collector configuration we'll use during this exercise.
...
``` { "name": "[background] run otel collector scenario 13" }
source .env
$BASE_DIR/dynatrace-otel-collector --config=$BASE_DIR/scenario13.yaml
```
...
![scenario13 dynatrace results](images/scenario13-dql-1.png)
...
- [Click here to continue :octicons-arrow-right-24:](scenario14.md)
</div>